...
#sudo apt-get install -y npm fail2ban
...
cd
cd /opt
sudo git clone --branch=12.0 https://shahnoor:Yk92hwgayBZk8Hge-Hht@git.bistasolutions.com/bistasolutions/odoo_enterprise.git --single-branch 
ls -l
